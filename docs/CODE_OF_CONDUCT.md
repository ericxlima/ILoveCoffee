# ILoveCoffee - Código de Conduta

Este código de conduta vale para todos os projetos de @ericxlima.
...
Exemplos de representação da nossa comunidade incluem usar um endereço de e-mail oficial, postar em contas oficiais de mídias sociais ou atuar como uma pessoa indicada como representante em um evento online ou offline. A representação de um projeto pode ser ainda definida e
esclarecida pelos administradores do projeto.

## Aplicação

Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato *eric.vinlima@gmail.com*.
Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa, de acordo com as [Diretrizes de Impacto na Comunidade](https://www.github.com/ericxlima/ILoveCoffee/blob/master/docs/GUIDELINES.md)
